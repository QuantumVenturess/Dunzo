...
- (void)createTodayButton;
{
    ...
    [self.todayButton setTitleColor: [UIColor whiteColor] 
      forState: UIControlStateNormal];
    // [self.todayButton setBackgroundImage:[self todayBackgroundImage] forState:UIControlStateNormal];
    self.todayButton.backgroundColor = [UIColor gray: 160];
...
- (void)createSelectedButton;
{
    ...
    [self.selectedButton setTitleColor: [UIColor whiteColor] 
      forState: UIControlStateNormal];
